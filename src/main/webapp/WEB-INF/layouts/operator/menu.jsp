...
-------------------->
			<div class="menu-mobile menu-activated-on-click color-scheme-dark">
				<div class="mm-logo-buttons-w">
					<a class="mm-logo" href="index.html"><img src="resources/img/logo.png"><span>Clean Admin</span></a>
...
-------------------->
			<div class="desktop-menu menu-side-w menu-activated-on-click">
				<div class="logo-w">
					<a class="logo" href="index.html"><img src="${pageContext.servletContext.contextPath}/resources/img/logo.png"><span>Clean Admin</span></a>
				</div>
				<div class="menu-and-user">
					<%-- <div class="logged-user-w">
						<div class="logged-user-i">
							<div class="avatar-w"><img alt="" src="${pageContext.servletContext.contextPath}/resources/img/avatar1.jpg"></div>
							<div class="logged-user-info-w">
								<div class="logged-user-name">Maria Gomez</div>
								<div class="logged-user-role">Administrator</div>
							</div>
