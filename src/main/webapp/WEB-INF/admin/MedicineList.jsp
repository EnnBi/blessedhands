				...
				<div class="content-i">
					<div class="content-box">
						<div class="element-wrapper">
							<h6 class="element-header">List of all Medicines</h6>
									...
									<table class="table table-lightborder table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td class="text-center"><a href="/medicine/edit/${medicine.id}"><i class="os-icon os-icon-edit-1"></i><span>Edit</span></a>&nbsp;&nbsp;<a href="/medicine/delete/${medicine.id}"><i class="os-icon os-icon-ui-15 "></i><span>Delete</span></a></td>
											</tr>
											</c:forEach>
										</tbody>
									</table>
